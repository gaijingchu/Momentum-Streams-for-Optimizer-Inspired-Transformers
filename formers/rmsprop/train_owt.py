"""DDP training script for RMSPropFormer (per-coord precond, no momentum) on OpenWebText (multi-GPU).

Factorial-ablation cell: No-momentum x Per-coordinate preconditioning. Mirrors
adam_train_owt.py hyperparameters for fair comparison.
...
CKPT_DIR = os.path.join(CACHE, "checkpoints_rmsprop_owt")
SEED = 42
