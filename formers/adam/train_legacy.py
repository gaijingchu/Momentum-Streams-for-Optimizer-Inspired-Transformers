"""Training script for Adam+Lie-Trotter AdamFormer on TinyStories."""
...
from formers.adam.model import AdamFormer
...
def configure_optimizers(model: AdamFormer):
...
def main():
    ...
    wandb.init(project="adamformer", config=config)
