"""Downstream evaluation of TMMFormer using lm-evaluation-harness v0.4.3."""
...
from formers.tmm.eval_model import TMMFormerLM


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--checkpoint", default="checkpoints_tmm/best.pt")
    parser.add_argument("--output-dir", default="eval_results_tmm")
    ...
    lm = TMMFormerLM(checkpoint_path=args.checkpoint, device=args.device)
