"""DDP training script for Muon+Lie-Trotter MuonFormer on OpenWebText (multi-GPU).

Factorial-ablation cell: Heavy-ball x Spectral preconditioning.
...
from formers.muon.model import MuonFormer
...
CKPT_DIR = os.path.join(CACHE, "checkpoints_muon_owt")
...
def main():
    ...
    if rank == 0:
        config = {
            "model": "MuonFormer-small-OWT",
            "variant": "Muon+Lie-Trotter",
