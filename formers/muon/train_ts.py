"""DDP training script for Muon+Lie-Trotter MuonFormer on TinyStories (multi-GPU).
...
def main():
    ...
    if rank == 0:
        ...
        wandb.init(project="muonformer", config=config, resume="allow")
