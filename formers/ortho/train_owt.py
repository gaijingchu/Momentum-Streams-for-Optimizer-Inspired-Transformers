"""DDP training script for OrthoFormer (per-token head-wise NS, no momentum) on OpenWebText (multi-GPU).

Factorial-ablation cell: No-momentum x Spectral preconditioning. MuonFormer
with the EMA momentum buffer removed; mirrors muon_train_owt.py hyperparameters.
...
CKPT_DIR = os.path.join(CACHE, "checkpoints_ortho_owt")
SEED = 42
