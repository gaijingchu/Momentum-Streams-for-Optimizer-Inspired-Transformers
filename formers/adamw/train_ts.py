"""DDP training script for AdamW+Lie-Trotter AdamWFormer on TinyStories (multi-GPU).
...
from formers.adamw.model import AdamWFormer
...
def main():
    ...
    if rank == 0:
        ...
        wandb.init(project="adamwformer", config=config, resume="allow")
