"""DDP training script for HBFormer (Heavy-ball + Lie-Trotter) on OpenWebText (multi-GPU).

Factorial-ablation cell: Heavy-ball momentum x No preconditioning. Mirrors the
hyperparameters of adam_train_owt.py / yurii_train_owt.py for fair comparison.
...
CKPT_DIR = os.path.join(CACHE, "checkpoints_hb_owt")
SEED = 42
