"""DDP training script for ShampooFormer (per-token head-wise R, no momentum) on OpenWebText (multi-GPU).

Factorial-ablation cell: No-momentum x Full-matrix preconditioning. SOAPFormer
with the first-moment buffer removed; mirrors soap_train_owt.py hyperparameters
...
CKPT_DIR = os.path.join(CACHE, "checkpoints_shampoo_owt")
SEED = 42
